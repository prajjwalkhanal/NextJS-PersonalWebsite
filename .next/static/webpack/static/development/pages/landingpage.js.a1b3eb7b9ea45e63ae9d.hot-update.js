      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(document.getElementById('Name').getAttribute('value'));

          case 4:
            console.log(document.getElementById('Name').getAttribute('value')); //document.getElementById("Name").setAttribute('value',"fdasfasda");
...
//# sourceMappingURL=landingpage.js.a1b3eb7b9ea45e63ae9d.hot-update.js.map