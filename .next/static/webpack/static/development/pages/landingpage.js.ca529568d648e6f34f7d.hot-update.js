      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            formData = {};
            console.log(e.currentTarget.name[id]);
            console.log(e.currentTarget.email[id]); //console.log(document.getElementById('Name').getAttribute('htmlFor'));
...
//# sourceMappingURL=landingpage.js.ca529568d648e6f34f7d.hot-update.js.map