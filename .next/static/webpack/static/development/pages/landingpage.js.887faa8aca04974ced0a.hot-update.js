...
function Contact() {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            console.log(e.currentTarget.elements.value); //console.log(document.getElementById('Name').getAttribute('htmlFor'));
  ...
  return __jsx("div", {
    ...
    type: "Email",
    name: "Email",
    defaultValue: "joh.doe@gmail.com",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 66,
...
//# sourceMappingURL=landingpage.js.887faa8aca04974ced0a.hot-update.js.map