    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function handleOnSubmit$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            formData = {}; //console.log(e.currentTarget.name.inputRootCustomClasses);

            console.log(e.currentTarget.elements.email.inputRootCustomClasses); //console.log(document.getElementById('Name').getAttribute('htmlFor'));
...
//# sourceMappingURL=landingpage.js.98343f971daf5114aa22.hot-update.js.map