      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            formData = {};
            console.log(e.currentTarget.name[1]);
            console.log(e.currentTarget.email[5]); //console.log(document.getElementById('Name').getAttribute('htmlFor'));
...
//# sourceMappingURL=landingpage.js.41f63ab30e97e4e1cc5a.hot-update.js.map