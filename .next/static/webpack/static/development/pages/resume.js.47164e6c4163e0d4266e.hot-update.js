...
function AboutMe() {
  ...
  }, "Understanding of SDLC, Traditional, Agile, and other methodologies"), "Knowledge of version control system like Git and used source code management tools GitHub and Bitbucket including command line application Managed Amazon Web Services like Virtual Private cloud (VPC) EC2, S3 bucket, RDS, ELB, ASG, AMI, IAM and others Good Working experience with bash script Hand-on experience with database (MySQL, SQLite) Good knowledge of HTML5, CSS3, C and PHP Excellent understanding of Active Directory, DHCP, DNS, Remote Desktop, Exchange server and File Server Experience in administering SaaS, such as Microsoft Azure, Dropbox and Zoom Worked with FortiGate Firewall to enhance organizational security Experience in issue tracking tool like Jira"))));
}

/***/ })

})
//# sourceMappingURL=resume.js.47164e6c4163e0d4266e.hot-update.js.map