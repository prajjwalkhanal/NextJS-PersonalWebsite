      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(document.getElementById('Name').nodeValue);

          case 4:
            console.log(document.getElementById('Name').nodeValue); //document.getElementById("Name").setAttribute('value',"fdasfasda");
...
//# sourceMappingURL=landingpage.js.b30f74f86ee2bdf5310f.hot-update.js.map