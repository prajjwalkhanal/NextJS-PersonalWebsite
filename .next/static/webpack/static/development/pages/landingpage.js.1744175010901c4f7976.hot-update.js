      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(document.getElementById('Name').getAttribute('labelText'));

          case 4:
            console.log(document.getElementById('Name').getAttribute('labelText')); //document.getElementById("Name").setAttribute('value',"fdasfasda");
...
//# sourceMappingURL=landingpage.js.1744175010901c4f7976.hot-update.js.map