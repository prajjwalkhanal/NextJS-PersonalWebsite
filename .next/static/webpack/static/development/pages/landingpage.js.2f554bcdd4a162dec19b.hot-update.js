    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function handleOnSubmit$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            formData = {}; //console.log((e)=>document.getElementById('Name').getAttribute('value'));

            _context.next = 4;
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(document.getElementById('Name').getAttribute('labelProps'));

          case 4:
            console.log(document.getElementById('Name').getAttribute('labelProps')); //document.getElementById("Name").setAttribute('value',"fdasfasda");
...
//# sourceMappingURL=landingpage.js.2f554bcdd4a162dec19b.hot-update.js.map