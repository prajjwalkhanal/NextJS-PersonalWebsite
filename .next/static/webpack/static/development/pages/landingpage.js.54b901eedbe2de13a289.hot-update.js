    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function handleOnSubmit$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            console.log(this.getElementById('Name').getAttribute('value')); //document.getElementById("Name").setAttribute('value',"fdasfasda");
...
//# sourceMappingURL=landingpage.js.54b901eedbe2de13a289.hot-update.js.map